...
export const CollectionArchive: React.FC<Props> = props => {
  ...
  //   categories = categoryFilters.map(cat => {}).join(",");
  // }
  ...
  useEffect(() => {
    ...
    let categories: string = "";
    if (categoryFilters && categoryFilters.length > 0) categories = categoryFilters.join(",");
            ...
            if (typeof result === "object" && result !== null) {
              return (
                <div className={classes.column} key={index}>
                  <Card className="mb-20" doc={result} relationTo={relationTo} showCategories />
                </div>
              );
            }
